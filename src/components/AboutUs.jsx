    ...
    return (
        <section className='text-[#140819] bg-[#F8EBFF] w-[360px] xl:w-full xl:flex xl:flex-col'>
            <div className='xl:w-[1280px] xl:flex xl:flex-col xl:relative xl:self-center'>
                <img src={imgVideo} className='w-full mb-[43px] xl:mt-0 xl:mb-0' alt='Video presentación Casa Violeta' />
            ...
            <div className='mx-[18px] xl:flex xl:flex-col xl:mx-0 xl:bg-[#E5B2FF]'>
                <div className='xl:max-w-[1280px] xl:self-center xl:flex xl:justify-center xl:py-[50px] xl:px-[60px] xl:mb-0'>
                    <div className='xl:mr-[119px]'>
                        <h3 className='mb-[30px] text-xl font-medium leading-normal xl:mb-0 xl:text-[38px] xl:font-semibold xl:pb-[50px]'>¿Quienes somos?</h3>
