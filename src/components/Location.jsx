...
function Location(){ 
    return (
        <section className="mb_[100px]">
        <div className=" text-[#E5B2FF] bg-[#543366] text-center py-[50px] text-[38px] ">
            <h2>Mapa </h2>
        </div>
    <div className="flex flex-wrap justify-center items-center  mt-[100px] mx-[6opx] ">
